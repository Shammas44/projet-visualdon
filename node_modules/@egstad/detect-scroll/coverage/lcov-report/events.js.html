...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const eventsDefault = ['scrollStart', 'scrollStop']
...
export function eventsSetup(eventOverrides, isVertical, isHorizontal) {
  ...
  // defaults
    ...
    return [
      ...eventsDefault,
      ...(isVertical ? eventsVertical : <span class="branch-1 cbranch-no" title="branch not covered" >[])</span>,
      ...(isHorizontal ? <span class="branch-0 cbranch-no" title="branch not covered" >eventsHorizontal </span>: []),
    ]
  }
}
&nbsp;
...
export function eventsDestroy(element, events) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (typeOf(events)) {
    Object.entries(events).forEach((event) =&gt; {
      const [key, value] = event
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Tue Jul 20 2021 17:42:47 GMT-0700 (Pacific Daylight Time)
            </div>
        </div>
